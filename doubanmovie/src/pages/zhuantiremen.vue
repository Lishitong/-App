...
export default {
  ...
  methods: {
    ...
    getdata(start) {
      this.JSONP(
        "https://api.douban.com/v2/movie/in_theaters?apikey=0b2bdeda43b5688921839c8ecb20399b&city=%E5%8C%97%E4%BA%AC&start=" +
          start +
          "&count=5&client=somemessage&udid=dddddddddddddddddddddd",
        null,
        (err, data) => {
          this.bol = false;
