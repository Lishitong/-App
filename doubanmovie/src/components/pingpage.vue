<template lang="html">
 <div class="pingpage">
   ...
   <h1>短评<span>{{msg.count}}</span>条</h1>
...
export default {
  ...
  methods: {
    ...
    getData() {
      jsonp("https://api.douban.com/v2/movie/subject/" + this.id + "/comments?apikey=0b2bdeda43b5688921839c8ecb20399b&count=20&client=something&udid=dddddddddddddddddddddd", null, (err, data) => {
        if (err) {
          console.error(err);
        } else {
          this.msg = data;
